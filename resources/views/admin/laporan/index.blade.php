...
@section('content')
    ...
    <div class="container-fluid pt-3">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <p class="font-weight-bold mb-0" style="font-size: 20px">Halaman Laporan Absensi</p>
            <ol class="breadcrumb breadcrumb-transparent mb-0">
                <li class="breadcrumb-item">
                    <a href="/dashboard">Dashboard</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Laporan Absen
                </li>
            </ol>
        </div>
        <div class="w-100 p-2">
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            table = DataTableGenerator('#table-data', '/laporan-absen/data', [
            ...
            $('#btn-cetak').on('click', function (e) {
                ...
                let tgl1 = $('#tgl1').val();
                let tgl2 = $('#tgl2').val();
                window.open('/laporan-absen/cetak?tgl1=' + tgl1 + '&tgl2=' + tgl2, '_blank');
            })
        });
    </script>
@endsection
